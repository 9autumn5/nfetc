...
TEST_DATA_PATH = "%s/corpus/test" % DATA_PATH
...
tWIKI_ALL = "%s/tall.txt" % WIKI_DATA_PATH
tWIKI_TRAIN = "%s/ttrain.txt" % WIKI_DATA_PATH
tWIKI_VALID = "%s/tdev.txt" % WIKI_DATA_PATH
tWIKI_TEST = "%s/ttest.txt" % WIKI_DATA_PATH
...
TEST_ALL = "%s/all.txt" % TEST_DATA_PATH
TEST_TRAIN = "%s/train.txt" % TEST_DATA_PATH
TEST_VALID = "%s/dev.txt" % TEST_DATA_PATH
TEST_TEST = "%s/test.txt" % TEST_DATA_PATH

TEST_TYPE = "%s/type.pkl" % TEST_DATA_PATH
TEST_TRAIN_CLEAN = "%s/train_clean.tsv" % TEST_DATA_PATH
TEST_TEST_CLEAN = "%s/test_clean.tsv" % TEST_DATA_PATH
